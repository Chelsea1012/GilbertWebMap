var size = 0;
var placement = 'point';
function categories_Environmentquality_9(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case 'Excellent':
...
var style_Environmentquality_9 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_Environmentquality_9(feature, value, size, resolution, labelText,
